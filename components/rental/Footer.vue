    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:col-span-1">
          <div class="flex items-center mb-4">
            ...
            <div class="flex flex-col">
              <span class="text-lg font-bold leading-tight">Nigerian Shortlet</span>
              <span class="text-lg font-bold text-primary leading-tight">Community</span>
            </div>
          </div>
          <p class="text-gray-400 mb-4">
            Your trusted Nigerian community for comfortable and affordable shortlet rentals across the country.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-4">
            ...
            <li class="flex items-center">
              ...
              <span class="text-gray-400">info@nsc.ng</span>
            </li>
            <li class="flex items-center">
              <svg class="w-5 h-5 text-primary mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="border-t border-gray-700 pt-8 text-center">
        <p class="text-gray-400">
          &copy; {{ new Date().getFullYear() }} Nigerian Shortlet Community (NSC). All rights reserved.
        </p>
      </div>
    </div>
  </footer>
